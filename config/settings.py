"""
Django settings for HamroKotha Rental Platform.

Kathmandu Valley Rental Property Platform
"""
...
# Add debug toolbar in development (disabled to avoid redirect interception)
# if DEBUG:
...
DEFAULT_FROM_EMAIL = config('EMAIL_HOST_USER', default='noreply@hamrokotha.com')

# Site Settings
SITE_NAME = config('SITE_NAME', default='HamroKotha')
